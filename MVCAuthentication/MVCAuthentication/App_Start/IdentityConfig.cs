...
namespace MVCAuthentication
{
    ...
    public class ApplicationUserManager : UserManager<ApplicationUser>
    {
        ...
        public static ApplicationUserManager Create(IdentityFactoryOptions<ApplicationUserManager> options, IOwinContext context) 
        {
            ...
            manager.UserLockoutEnabledByDefault = true; //blokiruet pol'zovatelja posle 5i popytok vxoda
            ...
            manager.RegisterTwoFactorProvider("Email Code", new EmailTokenProvider<ApplicationUser> //vtoroe podtverzhdenie, n-r cherez sms, nado instalirovat' dll i vysylat' sms na phone
            {
